...
class App(ctk.CTk):
    def __init__(self):
        ...
        ctk.set_default_color_theme(constants._THEME_FILE_LOCATION)
        ...
        self.x_pad = constants._DEFAULT_PAD_X
        self.y_pad = constants._DEFAULT_PAD_Y
        
        self.app_width = constants._SCREEN_WIDTH // 2
        self.app_height = constants._SCREEN_HEIGHT // 2
        self.app_x_pos = constants._SCREEN_WIDTH // 2 - self.app_width // 2
        self.app_y_pos = constants._SCREEN_HEIGHT // 2 - self.app_height // 2

        self.h1 = constants._H1_FONT
        self.h2 = constants._H2_FONT
        self.h3 = constants._H3_FONT
        self.p = constants._P_FONT
